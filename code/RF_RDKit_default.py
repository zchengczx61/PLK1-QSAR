...
dataset_file = 'train3a.csv'
dataset_file1 = 'valid3.csv'
dataset_file2 = 'test3.csv'
task = ['pic50']
...
sklearn_model = RandomForestRegressor(max_features='auto', n_estimators=100, max_depth=None)
